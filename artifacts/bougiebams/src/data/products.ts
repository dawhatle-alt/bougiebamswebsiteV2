...
export const productMeta: Record<string, ProductMeta> = {
  ...
  prod_3:  { images: [productJadeTilesSet],rating: 5.0, reviewCount: 15 },
  ...
  prod_6:  { images: [productVelvetPlaymat], rating: 4.9, reviewCount: 33 },
  prod_7:  { images: [heroTile4],          rating: 4.8, reviewCount: 21 },
  prod_8:  { images: [mahjongTilesCloseup],rating: 5.0, reviewCount: 8 },
  prod_9:  { images: [productTravelCaseSet], rating: 4.9, reviewCount: 45, isBestseller: true },
  prod_10: { images: [productMatTravelSet],rating: 4.7, reviewCount: 12 },
  prod_11: { images: [productPoolFloatMat],rating: 4.8, reviewCount: 27 },
  prod_12: { images: [productGoldMahjongBag], rating: 4.5, reviewCount: 14 },

  tiles_debutante:   { images: [heroTile1],          rating: 4.9, reviewCount: 18 },
  ...
  tiles_intlcard:    { images: [productJadeTilesSet],  rating: 4.6, reviewCount: 9 },

  mats_minitravel:   { images: [productMatTravelSet],  rating: 4.7, reviewCount: 12 },
  mats_rackpushers:  { images: [productVelvetPlaymat], rating: 4.8, reviewCount: 27 },
  mats_tablecloths:  { images: [productTablecloth],    rating: 4.9, reviewCount: 16 },
  mats_aquajong:     { images: [productPoolFloatMat],  rating: 4.5, reviewCount: 7, isNew: true },

  storage_zipperedbags: { images: [productRosegold],       rating: 4.8, reviewCount: 20 },
  storage_matstorage:   { images: [productRackStorageRoll], rating: 4.7, reviewCount: 11 },
  storage_acrylicboxes: { images: [productAcrylicBox],     rating: 4.9, reviewCount: 13 },

  acc_babies:    { images: [productTileKeychain],    rating: 5.0, reviewCount: 8, isNew: true },
  acc_cardfolios:{ images: [productCardBook],         rating: 4.6, reviewCount: 10 },
  acc_book:      { images: [productPinkMetallicBag],  rating: 4.9, reviewCount: 24 },
