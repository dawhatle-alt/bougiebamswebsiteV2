...
- **Tax Records** — the three ledgers an accountant asks for at year end, with a CSV **Accountant packet** covering all of them.
  ...
  - **Inventory purchased for resale** — date, item, vendor, quantity, unit cost, shipping and tax. This is *cost of goods sold*, not an expense: it's deducted as items sell, not when you buy them, which is why it's tracked separately from the spending above.
